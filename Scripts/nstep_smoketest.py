...
def case_simple_sequence() -> None:
    ...
    s0, a0, aux0, R0, priority0, s3, done0, h0, actor0, *rest = outs[0]
    ...
    s1, a1, aux1, R1, priority1, s4, done1, h1, actor1, *rest = outs[1]
    ...
    s2, a2, aux2, R2, priority2, s5, done2, h2, actor2, *rest = outs[2]
...
def case_actor_boundary_split() -> None:
    ...
    for tup in outs[1:]:
        if len(tup) == 9:
            horizons.append(tup[7])
        elif len(tup) == 8:
            horizons.append(tup[6])
